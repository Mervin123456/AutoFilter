...
API_ID = int(environ.get('API_ID', '10544811'))
API_HASH = environ.get('API_HASH', '96011086da521fb9f6a3ec30508dbdf4')
OWNER_ID = environ.get('OWNER_ID', '1232073975')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1232073975').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002220898510').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Dp:Dp@cluster0.nt2y4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002163314245')) #Log channel id ( make sure bot is admin )
DUMP_CHNL = int(environ.get('DUMP_CHNL', '-1002243008790'))
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'Iio4KIdUBRb5uh43ytQn2a3W2et2')
